...
N("VBAT_IN",   "Входное бортовое питание +12В, выводы 1-2 разъёма J1",
  ("J1","1"), ("J1","2"), ("D1","1"))
N("VBAT_PROT", "После защиты от переполюсовки (D1), перед входным фильтром L1",
  ("D1","2"), ("L1","1"))
N("VCC_12V",   "Силовая шина +12В после фильтра помех L1, с TVS D2 и конденсаторами",
  ("L1","2"), ("D2","2"), ("C1","1"), ("C2","1"), ("C20","1"), ("C3","1"),
  ("U6","1"),
  ("U2","5"), ("U3","5"), ("U4","5"), ("U5","5"),
...
N("V5_SENS",   "Общий выход +5В/опора на датчики и края потенциометров ОС (J1:17). Диод D4 исключает обратную подачу +12В снаружи",
  ("D4","2"), ("D5","2"), ("C16","1"), ("C17","1"), ("C18","1"), ("C19","1"),
  ("J1","17"),
...
N("GND",      "Общий провод (кузов автомобиля)",
  ...
  ("U6","2"), ("U7","2"), ("U8","2"), ("U8","8"), ("C20","2"), ("D5","1"),
  ("D2","1"),
...
C = {}
# --- Силовые / защита ---
C.update(comp("L1",  "Феррит/дроссель по входу +12В (помехи)", "Device", "L",
              "Inductor_SMD:L_1210_3225Metric", "Power_Protection"))
C.update(comp("C20", "1uF 25В керамика по входу +12В (ВЧ-фильтр)", "Device", "C",
              "Capacitor_SMD:C_0805_2012Metric", "Power_Protection"))
C.update(comp("D5",  "SMBJ5.0A / 5,6В защита линии +5В датчиков", "Device", "D_Zener",
